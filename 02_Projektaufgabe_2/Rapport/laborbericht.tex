...
\begin{document}	
	...
	\section{Architektur}
		\begin{figure}[!ht] %add a figure and force it to be in the top of the page
			\centering	
			\centerline{\includegraphics[width=20cm] {../architecture.PNG}} %add an image in the center of the page with a width of 20cm
	...
	\section{Zustandsdiagramme}
		...
		\subsection{Vorwärtszähler / Counter}
			...
			\begin{figure}[!ht]
				\centering	
				\centerline{\includegraphics[width=20cm] {../counter_snSec.png}} %ajouter une image de taille 20cm, centrée
				\caption{Zustandsdiagramm des Sekundeneinheit-Vorwärtszählers}
			\end{figure}
	
			\begin{flushleft}
				 Der Sekundeneinheit-Vorwärtszähler zählt nur wenn man in Stop mode ist (start=0) und wenn man auf die Sekunde-Taste betätigt.
				 \newline
			...
			\begin{figure}[!ht]
				\centering	
				\centerline{\includegraphics[width=20cm] {../counter_tSec.png}} %ajouter une image de taille 20cm, centrée
				\caption{Zustandsdiagramm des Sekundenzehner-Vorwärtszählers}
			\end{figure}
		
			\begin{flushleft}
				Der Sekundenzehner-Vorwärtszähler zählt nur wenn man in Stop mode ist, wenn eine Betätige auf der Sekunde-Taste gibt und wenn die 	Sekundeeinheit von 9 bis 0 geht.
			...
			\begin{figure}[!ht]
				\centering	
				\centerline{\includegraphics[width=20cm] {../counter_snMin.png}} %ajouter une image de taille 20cm, centrée
			...
			\begin{figure}[!ht]
				\centering	
				\centerline{\includegraphics[width=20cm] {../counter_tMin.png}} %ajouter une image de taille 20cm, centrée
		...
		\subsection{Rückwärtszähler / Decounter}
			...
			\begin{figure}[!ht]
				\centering	
				\centerline{\includegraphics[width=20cm] {../decounter_snSec.png}} %ajouter une image de taille 20cm, centrée
				\caption{Zustandsdiagramm des Sekundeneinheit-Rückwärtszählers}
			\end{figure}
	
			\begin{flushleft}
				Der Sekundeneinheit-Rückwärtszähler fängt mit dem letzten Wert von dem Sekundeneinheit-Vorwärtszähler, wenn man in Start mode ist und wenn eine Sekunde vergangen ist.
				\newline
			...
			\begin{figure}[!ht]
				\centering	
				\centerline{\includegraphics[width=20cm] {../decounter_tSec.png}} %ajouter une image de taille 20cm, centrée
			...
			\begin{figure}[!ht]
				\centering	
				\centerline{\includegraphics[width=20cm] {../decounter_snMin.png}} %ajouter une image de taille 20cm, centrée
				\caption{Zustandsdiagramm des Minuteneinheits-Rückwärtszählers}
			\end{figure}
	
			\begin{flushleft}
				 Der Minuteneinheits-Rückwärtszähler fängt mit dem letzten Wert von dem Minuteneinheit-Vorwärtszähler, wenn man in Start mode ist und wenn die Sekundenzehner von 0 zu 5 geht.
			\end{flushleft}
			...
			\begin{figure}[!ht]
				\centering	
				\centerline{\includegraphics[width=20cm] {../decounter_tMin.png}} %ajouter une image de taille 20cm, centrée
				\caption{Zustandsdiagramm des Minutenzehner-Rückwärtszählers}
			\end{figure}
	
			\begin{flushleft}
				Der Minutenzehner-Rückwärtszähler fängt mit dem letzten Wert von dem Minutenzehner-Vorwärtszähler, wenn man in Start mode ist und wenn die Minuteneinheit von 0 zu 9 geht.
			\end{flushleft}
	...
	\section{Simulation mit ModelSim}
		...
		\begin{figure}[!ht]
			\centering	
			\centerline{\includegraphics[width=20cm] {../debounce.png}} %ajouter une image de taille 20cm, centrée
		...
		\begin{flushleft}
			\begin{enumerate}
				...
				\begin{itemize}
				{\small
					\item Wenn Rauschen auf einer Taste gibt, kann einer unwünsche Wert stattfinden. Deswegen soll ein Debounce herstellen, um diese Situation zu vermeiden. 
				...
				{\small
					...
					\item Ab 500ns fäng wieder eine Betätige während 400ns. Das ist genug. Man hat also ein push, die eine richtige Betätige darstellt.
		...
		\subsection{Frequenzteiler}
			\begin{figure}[!ht]
				\centering	
				\centerline{\includegraphics[width=20cm] {../freqDiv.png}} %ajouter une image de taille 20cm, centrée
		...
		\subsection{Vorwärtszähler (Counter)}
			\begin{figure}[!ht]
				\centering	
				\centerline{\includegraphics[width=20cm] {../counter.png}} %ajouter une image de taille 20cm, centrée
				...
				\begin{enumerate}
					...
					\item \textbf{Ergebnis (Siehe Abbildung 12)}
						\begin{itemize}
							...
							\item Nach Betätigen die Sec- und Min-Taste geht die Sekunden und Minuten wieder zu null, weil der maximale Wert (99min59sec) erreichen ist.
							\item Ab 60ns kann man sehen, dass die Werte nach Betätigen der Min- und Sec-Taste hochzählen (und die mit dem Clock synchronisiert sind).
		...
		\subsection{Rückwärtszähler (Decounter)}
			\begin{figure}[!ht]
				\centering	
				\centerline{\includegraphics[width=20cm] {../decounter.png}} %ajouter une image de taille 20cm, centrée
				...
				\begin{enumerate}
					...
					\begin{itemize}
						{\small
							...
							\item Ab 2000ns zählt der Decounter wieder runter bis zu Null. Dann kann man sehen, dass der time over zu 1 geht. Das zeigt das Ende der Zeit.
						}
					\end{itemize}
		...
		\subsection{Audio / Ende der Zeit}
			\begin{figure}[!ht]
				\centering	
				\centerline{\includegraphics[width=20cm] {../audio.png}} %ajouter une image de taille 20cm, centrée
		...
		\subsection{Display}
			\begin{figure} [!ht]
				\centering	
				\centerline{\includegraphics[width=20cm] {../display.png}} %ajouter une image de taille 20cm, centrée
		...
		\subsection{Ganze Architektur (Timer)}
			\begin{figure}[!ht]
				\centering	
				\centerline{\includegraphics[width=20cm] {../timer.png}} %ajouter une image de taille 20cm, centrée
				\caption{Simulation des Rückwärtszählers}
			\end{figure}
				...
				\begin{enumerate}
					...
					\begin{itemize}
						{\small
							...
							\item Wir zählen diesen Wert wieder hoch, bis 3 Sekunden und gehen wir wieder in Start mode (ab 2600ns) bis man den 0 Wert erreichen (ab 4250ns)
							\item Dann gibt es die Signal-Töte und eine Ruhe, bis man auf den Start-Taste wieder betätigt (7250ns).
	...
	\section{Konklusion}
		...
		\begin{figure}[!ht]
			\centering	
			\centerline{\includegraphics[width=20cm] {../rtl_viewer.png}} %ajouter une image de taille 20cm, centrée
		...
		\begin{flushleft}
			...
			\newline
			Reihenweise sind jeden Spezifikatione mit einem Do-File geprüft (Siehe jede Schritt in 3. Simulation mit ModelSim). Alle Spezifikatione sind einhalten.
			\newline
